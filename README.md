...
**APA 7**
> De la Serna Tuya, J. M. (2025). *🇹🇷 Açık Araştırma Veri Setleri — de la Serna Tuya, Juan Moisés* [Dataset]. GitHub. https://github.com/juanmoisesd/research-hub-tr

**BibTeX**
```bibtex
@dataset{delaserna2025_research_hub_tr,
  author    = {De la Serna Tuya, Juan Moisés},
  title     = {🇹🇷 Açık Araştırma Veri Setleri — de la Serna Tuya, Juan Moisés},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/research-hub-tr},
